# 9194 SystemCore working repository

This is our repository for working with the new SystemCore alpha. We clone and work from our own repository to prevent user-error issues in interacting with the original repo. 

Add our README stuff here.


<i> Below is the readme of the base repository: </i>
